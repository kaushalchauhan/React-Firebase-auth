  ...
  return (
    <section className='h-screen w-screen flex items-center justify-center'>
      <div className="h-[50vh] min-w-[25vw] px-6 bg-green-300 border-2 border-black text-white text-center flex justify-center items-center flex-col gap-2">
        <h1 className='font-bold text-3xl text-blue-500 mb-3'>Login</h1>
        ...
        <p className='text-red-500 mt-2'>{errMsg}</p>
          <button className='px-8 py-2 text-xl rounded bg-blue-400 my-2 hover:bg-blue-500 transition-all duration-400' onClick={handleLogin}>Login</button>
         
          <p className='text-black text-left text-lg'>Don't have an account? 
            <Link to="/signup"><span className='underline hover:text-blue-500'>  Signup</span></Link>
          </p>
      </div>
    </section>
  )
